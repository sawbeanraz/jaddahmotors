  ...
  <main role='main' className='main-container'>
    ...
    <div className='container'>
      <div className="card-deck mb-3 text-center">
        <div className="card mb-4 box-shadow">
          ...
          <div className="card-body">
            <h1 className="card-title pricing-card-title"><small className="text-muted"></small>£40</h1>
        ...
        <div className="card mb-4 box-shadow">
          ...
          <div className="card-body">
            <h1 className="card-title pricing-card-title"><small className="text-muted">from</small> £99</h1>
            <ul className="list-unstyled mt-3 mb-4">
        ...
        <div className="card mb-4 box-shadow">
          ...
          <div className="card-body">
            <h1 className="card-title pricing-card-title"><small className="text-muted">from</small> £70</h1>
            <ul className="list-unstyled mt-3 mb-4">
      ...
      <div className="card-deck mb-3 text-center">
        <div className='card mb-4 box-shadow'>
          <div className='card-header'>
            <h4 className='my-0 font-weight-normal'>Repairing</h4>            
          </div>
          <div className='card-body'>
            <ul className='list-unstyled mt-3 mb-4'>
